...
SRC = r"c:/Users/roy/CodeBuddy/Digital-MonsterVpet/Digital-MonsterVpet/sprites/V9/V9.png"
OUT_DIR = r"c:/Users/roy/CodeBuddy/Digital-MonsterVpet/Digital-MonsterVpet/sprites/V9"
...
# 輸出 V9_00.png ~ V9_31.png（每張 203x16：12 個 16x16 tile，tile 間 1px 透明 gap）
...
for r in range(32):
    ...
    out.save(os.path.join(OUT_DIR, f"V9_{r:02d}.png"))
    print(f"[V9_{r:02d}.png] 已保存 {out.size}")
